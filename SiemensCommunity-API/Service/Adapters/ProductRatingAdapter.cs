...
namespace Service.Adapters
{
    public class ProductRatingAdapter
    {
        ...
        public IEnumerable<ProductRating> AdaptList(IEnumerable<Data.Models.ProductRating> productsRating)
        {
            return _productRatingAdapter.Map<IEnumerable<Data.Models.ProductRating>, IEnumerable<ProductRating>>(productsRating);
        }
    }
}
