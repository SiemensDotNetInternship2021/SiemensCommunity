...
namespace Service.Adapters
{
    public class CategoryAdapter
    {
        ...
        public IEnumerable<Category> AdaptList(IEnumerable<Data.Models.Category> category)
        {
            return _categoryAdapter.Map<IEnumerable<Data.Models.Category>, IEnumerable<Category>>(category);
        }
    }
}
