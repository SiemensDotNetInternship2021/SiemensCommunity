...
namespace SiemensCommunity.Adapters
{
    public class CategoryAdapter
    {
        ...
        public IEnumerable<Category> AdaptList(IEnumerable<Service.Models.Category> categories)
        {
            return _categoryAdapter.Map<IEnumerable<Service.Models.Category>, IEnumerable<Category>>(categories);
        }
    }
}
