...
namespace SiemensCommunity.Adapters
{
    public class ProductRatingAdapter
    {
        ...
        public IEnumerable<ProductRating> AdaptList(IEnumerable<Service.Models.ProductRating> productsRating)
        {
            return _productRatingAdapter.Map<IEnumerable<Service.Models.ProductRating>, IEnumerable<ProductRating>>(productsRating);
        }
    }
}
